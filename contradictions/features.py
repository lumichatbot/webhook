"""
    ...
    5 Hierarchy
    6 QoS
    7 Similarity (endpoints, services, groups, traffic, protocol and middleboxes)
"""
...
def protocol(sentence, hypothesis):
    """ similarity of targets vectors """
    ...
    if 'protocol' in sentence:
        stn_traffic = re.findall(protocol, sentence)

    if 'protocol' in hypothesis:
        hyp_traffic = re.findall(protocol, hypothesis)
