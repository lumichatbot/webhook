...
DATASET_SERVICE_ASSOCIATIONS = {
    "netflix": {"protocols": ["tcp", "https"], "traffics": ["streaming"]},
    "youtube": {"protocols": ["udp", "https", "quic"], "traffics": ["streaming"]},
    "facebook": {
        "protocols": ["tcp", "https"],
        "traffics": ["streaming", "social media"],
    },
    "AIM chat": {"protocols": ["tcp", "https", "http"], "traffics": ["social media"]},
    "instagram": {"protocols": ["tcp", "https"], "traffics": ["social media"]},
    "vimeo": {"protocols": ["tcp", "https"], "traffics": ["streaming"]},
    "amazon prime video": {"protocols": ["tcp", "https"], "traffics": ["streaming"]},
    "popcorn time": {"protocols": ["udp"], "traffics": ["peer2peer", "torrent"]},
    "stremio": {"protocols": ["udp"], "traffics": ["peer2peer", "torrent"]},
    "bittorrent": {"protocols": ["udp"], "traffics": ["peer2peer", "torrent"]},
    "utorrent": {"protocols": ["udp"], "traffics": ["peer2peer", "torrent"]},
    "CounterStrike": {"protocols": ["tcp"], "traffics": ["gaming"]},
    "Battlenet": {"protocols": ["tcp"], "traffics": ["gaming"]},
    "listserver": {"protocols": ["tcp", "smtp"], "traffics": ["email"]},
    "Everquest": {"protocols": ["tcp"], "traffics": ["gaming"]},
    "MSN audio": {
    ...
    "MSN chat": {"protocols": ["tcp", "http", "https"], "traffics": ["social media"]},
    "MSN application sharing": {
        "protocols": ["tcp", "http", "https"],
    ...
    "Sony Playstation 2": {"protocols": ["tcp"], "traffics": ["gaming"]},
    "Sorenson Videophone 200": {
        "protocols": ["tcp", "http", "https"],
        "traffics": [
            "social media",
    ...
    "irc": {"protocols": ["tcp", "http", "https"], "traffics": ["social media"]},
    "NETBIOS": {"protocols": ["tcp"], "traffics": []},
}
...
DATASET_TRAFFIC_ASSOCIATIONS = {
    ...
    "gaming": {
        "protocols": ["tcp"],
        "services": ["CounterStrike", "Battlenet", "Everquest", "Sony Playstation 2"],
    },
    "email": {
        "protocols": ["tcp", "snmp", "POP3", "secure POP", "IMAP", "secure IMAP"],
    ...
    "any": {"protocols": DATASET_PROTOCOLS, "services": DATASET_SERVICES},
}
...
NILE_ACTIONS_NEGATION = {" add ": " remove ", " allow ": " block ", " set ": " unset "}
